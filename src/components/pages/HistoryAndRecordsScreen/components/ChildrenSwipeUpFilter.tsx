        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          ...
          {type !== 'date' && (
            <TouchableOpacity
              onPress={() => {
                if (type === 'mapel') {
                  setSelectedTemporary(data.map(x => x?.id));
                } else {
                  setSelectedTemporary(data.map(x => x?.name));
                }
              }}>
            ...
            <ScrollView
              ...
              {dataFilter?.map((item: any, index: number) => {
                ...
                if (
                  ...
                  selectedTemporary?.includes(item?.name) ||
          ...
          <Button
            ...
            action={() => {
              if (type === 'mapel') {
                ...
                const mapelName = data
                  ?.filter(e => selectedTemporary.includes(e.id))
                  .map(e => e.name);

                setMapelName(mapelName);
              } else if (type === 'tipe') {

...
const LMSOnParentScreen = () => {
  const route = useRoute<RouteProp<ParamList, 'LMSOnParentScreen'>>();
  const navigation =
    useNavigation<StackNavigationProp<ParamList, 'LMSOnParentScreen'>>();
                  ...
                  (item: {
                    ...
                    return (
                      <ItemSubject
                        ...
                        img={item.path_url}
                        action={() =>
                          navigation.navigate('ReportOnParentScreen', {
                            data: paramsData,
                            subject: item,

...
const ScheduleItemVirtualMeeting: FC<Props> = ({
  data,
  button,
  refetchData,
  action,
    ...
    <View style={[styles.flexCol]}>
      <View
        ...
        <View style={styles.ViewSesiKelas}>
          <Text style={styles.sesikelas}>Rapat Virtual</Text>
        </View>
      </View>
      <View style={[styles.flexRow, {gap: 18}]}>
        <View style={(styles.flexCol, {gap: 2, flex: 1})}>
          <View>
            <Text style={styles.title}>{data?.title || data?.sub_title}</Text>
          </View>
...
export {ScheduleItemVirtualMeeting};
